...
from langchain_langgraph.chain import make_chain, runnable_parallel_chain, runnable_lambda_chain
...
from langchain_langgraph.langgraph.img_save import save_langgraph_structure_img
import time
...
def response_from_langgraph(prompt, message_history=[], model_id:str="gpt-4o-mini"):
    ...
    inputs = {"input": prompt,
            "chat_history": [],
            "intermediate_steps":[]}
    output = set_workflow_to_app().invoke(inputs)
